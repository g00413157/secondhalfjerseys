...
$sql='CREATE TABLE `Merch` (
  ...
  ("Arsenal", "2023/24", "Away", "Arsenal Women Away Kit 2023/24", This Jersey includes RUSSO 23 on the back in WSL font", "Club", "WSL", "M", 50, "Jerseys/Arsenal-Women-23-Away-Front.jpeg"),
  ...
  ("Arsenal", "2024/25", "Third", "Arsenals Third jersey for the 2024/25 season featuring WILLIAMSON 6 on the back in WSL font and the Barclays Womens Super League patch on the right arm.", "Club", "WSL", "XXL", 60, "Jerseys/Arsenal-Women-24-Third-front.jpeg"),
  ...
  ("Spain", "2023/24", "Home", "Spain National Team Home Kit for 2023/24. Red with Yellow details, Printed with Alexia 11 ", "International", "FIFA", "XXL", 60, "Jerseys/Spain-23-front.jpeg"),
  ...
  ("Republic Of Ireland", "2023/24", "Away", "Republic of Ireland Away kit for 2023/24. White with modern green design.", "International", "UEFA", "XXL", 30, "Jerseys/IRE-23-Away-front.jpeg"),
